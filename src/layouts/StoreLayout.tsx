        ...
        <NavigationMenu className="flex-1 justify-center">
          <NavigationMenuList className="flex space-x-8">
            ...
            <NavigationMenuItem>
              <NavigationMenuLink
                href="/cart"
                className="flex flex-row items-center gap-3 hover:underline transition-colors duration-300">
                <ShoppingCart
                  size={16}
                  color="black"
                  className="group transition-transform duration-300 ease-in-out group-hover:translate-x-2"
                />
