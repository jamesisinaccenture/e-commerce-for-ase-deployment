...
import {
  ...
  CardFooter,
  CardContent,
} from "@/components/ui/card"; // Adjust the import based on your component structure
...
const StoreProductsPage = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-red-500">
